...
public class main extends AppCompatActivity {
    ...
    private static final String TAG = "CC:main";
    ...
    private static final String ACTIVITY_TO_SERVICE_BROADCAST = "CC_A_TO_S_BROADCAST";
    private static final String SERVICE_TO_ACTIVITY_BROADCAST = "CC_S_TO_A_BROADCAST";
    ...
    private currency_list adapter_currencylist;
    private ListView m_listview_rate;
    private currency_rate_list adapter_currencyratelist;
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            try {
                ...
                if (sel.equalsIgnoreCase("0")) {
                    m_ListViewSelected_C = currency_rate_db.currency_name[position];
    ...
    private OnItemSelectedListener selectedListener_Currency = new OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            Log.d(TAG, "Current selected item for currency [" + Integer.toString(nSelected) + "] is " + currency_rate_db.currency_name[position]);
            // update selected currency
            m_Selected_C[nSelected] = currency_rate_db.currency_name[position];
            // update another one
    ...
    private Runnable mTask = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                for (int i = 0; i < currency_rate_db.currency_name.length; i++) {
                    rate = online_intent.getExtras().getDouble(currency_rate_db.currency_name[i]);

                    if (rate > 0) {
                        m_DB.SetRates(currency_rate_db.currency_name[i], rate);
                    }
                }

                // send message to activity to update listview
                main.this.objHandler.sendEmptyMessage(GUI_UPDATE_LISTVIEW);
            } catch (Exception e) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // use global database
            m_DB = new currency_rate_db(this);
            ...
            adapter_currencylist = new currency_list(this, currency_rate_db.currency_name, currency_rate_db.currency_icon);
            ...
            adapter_currencyratelist = new currency_rate_list(this, currency_rate_db.currency_longname, currency_rate_db.currency_icon, m_DB.GetAllData());
            ...
            m_Base_C = mPrefs.getString(KEY_BASECURRENCY, currency_rate_db.currency_name[0]);
            adapter_currencyratelist.SetBaseCurrencyIndex(m_DB.GetCurrencyPosition(m_Base_C));
            m_text_BaseCurrency.setText(m_Base_C);

            m_Selected_C[ITEM_CURRENCYA] = mPrefs.getString(KEY_SEL_CURRENCYA, currency_rate_db.currency_name[0]);
            m_Selected_C[ITEM_CURRENCYB] = mPrefs.getString(KEY_SEL_CURRENCYB, currency_rate_db.currency_name[0]);
    ...
    public void onStart() {
        ...
        try {
            ...
            Intent i = new Intent(this, currency_converter_service.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_about:
                ...
                Intent about = new Intent(getApplicationContext(), sg.com.kaplan.pdma.currencyconverter.about.class);
                startActivity(about);
                break;
            case R.id.action_settings:
                // launch CurrencyPreference activity
                Intent setting = new Intent(getApplicationContext(), preferences.class);
    ...
    private Dialog createCurrencyEditDialog(Context context) {
        ...
        final View ContentView = inflater.inflate(R.layout.currency_rate_edit_dialog, null);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            if (default_cb.isChecked() == false) {
                                ...
                                if (m_ListViewSelected_C == currency_rate_db.currency_name[0]) {
